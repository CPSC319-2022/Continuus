export const blogPostDummyData = [
  {
    id: 1,
    name: "Jerry Jim",
    ...
    title:
      "Unraveling the Enigma of Time: A Comprehensive Guide to the Multiverse and Beyond",
    content:
  ...
  },
  {
    ...
    title:
      "When Elephants Dance on Clouds: The Intriguing Mysteries of Animal Behavior in Fiction",
    content:
  ...
  },
  {
    ...
    title:
      "Chronicles of the Alien Seas: An Expedition to the Uncharted Depths of Extraterrestrial Oceans",
    content:
  ...
  },
  {
    ...
    title:
      "The Orchestra of the Cosmos: A Symphony of Celestial Events, Astrophysics, and the Human Spirit",
    content:
  ...
  },
  {
    ...
    title:
      "Cooking Through the Ages: A Gastronomic Journey Across Continents, Cultures, and Time",
    content:
  ...
  },
  {
    ...
    title:
      "Language of the Trees: Discovering the Secrets and Wisdom of Forests from Around the World",
    content:
  ...
  },
  {
    ...
    title:
      "Virtual Utopia or Dystopia: Examining the Societal Impact of Immersive Technologies on Humanity",
    content:
  ...
  },
  {
    ...
    title:
      "Whispers from the Abyss: A Collection of Unsolved Mysteries, Cryptic Tales, and Enigmatic Riddles",
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur id erat lacus. Praesent sodales semper libero nec rutrum. Ut varius augue ipsum, sit amet convallis neque mattis nec. Mauris imperdiet sem at libero dignissim pharetra. Curabitur ac volutpat ex. Vestibulum suscipit nisi vel tempor rhoncus. Proin convallis lectus ac tristique elementum. Ut in mauris eget dui hendrerit finibus luctus ac quam. Mauris consectetur urna vel augue tempus egestas. Nunc lobortis maximus risus a feugiat. Phasellus nec hendrerit justo, ut euismod turpis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Cras at neque non arcu rhoncus luctus a at nulla. Vivamus egestas felis eu massa ultricies iaculis. Mauris imperdiet consequat nisi, ornare pulvinar mauris scelerisque a. Morbi semper mauris ex, ac hendrerit leo maximus a.",
    comments: [
      {
