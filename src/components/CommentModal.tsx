    ...
    <>
      {!!selectedPost && (
        <ReactModal
          ...
          className="absolute top-1/2 left-1/2 z-40 max-h-[75vh] w-11/12 max-w-5xl -translate-x-1/2 -translate-y-1/2 overflow-y-auto overflow-x-hidden rounded-md border bg-white p-8 outline-none md:w-1/2"
          shouldCloseOnEsc
