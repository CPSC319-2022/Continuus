...
export const Comment: React.FC<CommentProps> = ({
  ...
  return (
    ...
    <>
      {
        isDeletePending ?
          <div className="m-3 bg-slate-100 p-4 rounded-md">
              <h1>Are you sure you want to delete this comment?</h1>
              <button className="bg-red-600 hover:bg-red-800 text-white py-0.5 px-2 rounded ml-2 mt-3"
                      onClick={() => handleCommentDelete()}>
                  Delete
              </button>
              <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 py-0.5 px-2 rounded ml-2 mt-3"
                      onClick={(event) => {
                        event.preventDefault();
                        setIsDeletePending(false);
                      }}>
        ...
        !isDeleted && <div className="m-3 bg-slate-100 p-4 rounded-md">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-slate-400">{timeAgo(dateAdded)}{
              ...
              <div className="ml-auto">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                       className="h-5 w-5 bi bi-trash" viewBox="0 0 16 16">
                    <path
          ...
          {updateCommentMutation.isLoading ? (
            ...
            <div className="p-2 mt-3">
              ...
              />
              <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 py-0.5 px-2 rounded ml-2"
