...
> = ({ children, action, isOpen, closeDisabled, onRequestClose }) => {
  return (
    <Modal
      ...
      className="absolute top-1/2 left-1/2 z-40 w-11/12 -translate-x-1/2 -translate-y-1/2 rounded-md bg-white md:w-1/2"
    >
      <div className="flex h-12 w-full flex-row items-center justify-between border-b border-b-gray-200 pl-4 pr-4">
